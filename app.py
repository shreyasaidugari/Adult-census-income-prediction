...
@st.cache_resource
def load_model():
    with open("dectree_model.joblib", "rb") as f:
        return load(f)
...
input, select { background-color: #1f2937 !important; color: white !important; }
button { width: 100%; height: 50px; font-size: 18px; background-color: #2563eb !important; color: white !important; }
</style>
...
native_country = st.selectbox("Native Country", ["United-States","India","Mexico","Philippines","Germany","Canada","China","Japan","England","Italy","France"])
